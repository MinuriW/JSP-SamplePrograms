...
public class BookDAO {
	public Connection getConnection()
    {
        ...
        try{
			...
			con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","SYSTEM","shanu123");
	...
	public ArrayList<Book> getAllBooks()
    {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select id, name, price, author from book");
            while(rs.next())
            {
